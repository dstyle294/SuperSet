...
import { RenderExerciseInSearch } from "./RenderExerciseInSearch"
...
interface RenderAddExerciseProps {
  ...
  refreshing: boolean,
  setRefreshing: (show: boolean) => void,
  exercises: exerciseObj[],
  setExercises: (newList: exerciseObj[]) => void,
  workoutId: string,
  setWorkoutId: (newId: string) => void
}


export const RenderAddExercise: React.FC<RenderAddExerciseProps> = ({ showAddExercise, setShowAddExercise, refreshing, setRefreshing, exercises, setExercises, workoutId, setWorkoutId }) => {
